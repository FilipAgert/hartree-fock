...
$(DOBJ)/pot.o: $(DMOD)/constants.mod $(DMOD)/ho.mod $(DMOD)/geom.mod $(DMOD)/integrate.mod
$(DOBJ)/test_utils.o: $(DMOD)/constants.mod
$(DOBJ)/test_geom.o: $(DMOD)/geom.mod $(DOBJ)/test_utils.o
# Declare .mod files are generated by compiling .f90
$(DOBJ)/%.o: $(MOD)/%.mod

# Default target
all: main fit

# Rule: compile .f90 to .o and generate .mod files into $(DMOD)
